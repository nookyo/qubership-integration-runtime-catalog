...
public abstract class BuiltinValidation extends AbstractValidation {
    /**
     * Can be used for alerts without children (for example, snapshots count for a chain)
     */
    protected static final String VALIDATION_ALERT_ISSUES_COUNTER_PROP = "issuesCount";

    public BuiltinValidation(String id, String title, String description,
                             String suggestion, ValidationEntityType entityType, ValidationImplementationType implementationType,
                             ValidationSeverity severity) {
        super("built-in_" + id, title, description, suggestion, entityType, implementationType, severity);
    }
}
