...
public class ValidationAlreadyInProgressUnexpectedException extends RuntimeException {
    ...
    public ValidationAlreadyInProgressUnexpectedException(String message) {
        super(message);
    }

    public ValidationAlreadyInProgressUnexpectedException(String message, Throwable cause) {
        super(message, cause);
    }
}
