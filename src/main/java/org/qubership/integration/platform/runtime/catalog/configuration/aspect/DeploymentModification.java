...
/**
 * Used for deployment changes detection (create, remove).
 * Not compatible with {@link org.springframework.transaction.annotation.Transactional},
 * use {@link TransactionHandler} instead
 */
