...
public class ApiSpecificationExportException extends CatalogRuntimeException {
    ...
    public ApiSpecificationExportException(String errorMessage) {
        super(errorMessage);
    }

    public ApiSpecificationExportException(String errorMessage, Throwable cause) {
        super(errorMessage, cause);
    }

    public ApiSpecificationExportException(String errorMessage, Exception originalException) {
