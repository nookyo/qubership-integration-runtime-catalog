...
@Getter
@Setter
public class ExportedSpecificationGroup extends ExportedSystemObject {
    private List<ExportedSpecification> specifications;

    public ExportedSpecificationGroup(String id, ObjectNode objectNode, List<ExportedSpecification> specifications) {
        super(id, objectNode);
